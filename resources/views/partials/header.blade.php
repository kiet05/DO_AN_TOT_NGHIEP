                            ...
                            <div class="sherah-header__group">
                                <div class="sherah-header__group-two">
                                    <div class="sherah-header__right">
                                        ...
                                        <!-- Header Message (giữ nguyên demo) -->
                                        ...
                                        <!-- Header Alarm: THÔNG BÁO ĐƠN HÀNG (DYNAMIC) -->
                                        <div class="sherah-header__dropmenu">
                                            ...
                                            @if($unreadNotifications->count() > 0)
                                                <span class="sherah-header__count sherah-color1__bg">
                                            ...
                                            <div
                                                ...
                                                <ul class="sherah-dropdown-card_list">
                                                    @forelse($unreadNotifications->take(5) as $notification)
                                                        ...
                                                        <li>
                                                            <a
                                                                href="{{ $orderId ? route('admin.orders.show', $orderId) : '#' }}"
                                                                class="sherah-paymentm__name">
                                                                <div
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="48"
                                                                        ...
                                                                        <g id="Icon"
                                                                            ...
                                                                            <circle id="Ellipse_34"
                                                                                data-name="Ellipse 34" cx="24" cy="24"
                                                                                r="24"
                                                                                transform="translate(-14.293 -11.5)"
                                                                                fill="#6176fe"></circle>
                                                                            <g id="Group_55"
                                                ...
                                                <!-- nút xem tất cả -->
                                                <div class="sherah-dropdown-card__button">
                                                    <a href="notifications.html"
                                                        class="sherah-dropdown-card__sell-all">
