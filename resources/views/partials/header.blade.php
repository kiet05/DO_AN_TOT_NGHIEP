<header class="sherah-header">
                                ...
                                <div class="sherah-header__group-two">
                                    <div class="sherah-header__right">
                                        ...
                                        <div class="sherah-header__dropmenu sherah-header__dropmenu--messages">
                                            ...
                                            <svg class="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg"
                                                width="28.08" height="26.196" viewBox="0 0 28.08 26.196">
                                            ...
                                            <span class="sherah-header__message--animate sherah-color3__bg--light"><span
                                                    class="sherah-color3__bg"></span></span>
                                            <div class="sherah-dropdown-card sherah-dropdown-card__alarm sherah-border">
                                                ...
                                                <h3 class="sherah-dropdown-card__title sherah-border-btm">Recent Message
                                                </h3>
                                                <ul
                                                    class="sherah-dropdown-card_list sherah-chatbox__list sherah-chatbox__list__header">
                                                    <!-- Single List -->
                                                    <li>
                                                        <div class="sherah-chatbox__inner">
                                                            <div class="sherah-chatbox__author">
                                                                ...
                                                                <div class="sherah-chatbox__author-content">
                                                                    <h4 class="sherah-chatbox__author-title">Jamen
                                                                        Oliver</h4>
                                                                    <p class="sherah-chatbox__author-desc">Hey! You
                                                                        forgot your keys....</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="sherah-chatbox__inner">
                                                            <div class="sherah-chatbox__author">
                                                                ...
                                                                <div class="sherah-chatbox__author-content">
                                                                    <h4 class="sherah-chatbox__author-title">Orian Heho
                                                                    </h4>
                                                                    <p class="sherah-chatbox__author-desc">How are you?
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="sherah-chatbox__right">
                                                                <span
                                                                    class="sherah-chatbox__unread sherah-color1__bg">5</span>
                                                    ...
                                                    <li>
                                                        <div class="sherah-chatbox__inner">
                                                            <div class="sherah-chatbox__author">
                                                                ...
                                                                <div class="sherah-chatbox__author-content">
                                                                    <h4 class="sherah-chatbox__author-title">
                                                                        Brotherhood</h4>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="sherah-chatbox__inner">
                                                            <div class="sherah-chatbox__author">
                                                                ...
                                                                <div class="sherah-chatbox__author-content">
                                                                    <h4 class="sherah-chatbox__author-title">Rose
                                                                        Rovert</h4>
                                                                    <p class="sherah-chatbox__author-desc">Of course I
                                                                        work the finaly done ....</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <div class="sherah-chatbox__inner">
                                                            <div class="sherah-chatbox__author">
                                                                ...
                                                                <div class="sherah-chatbox__author-content">
                                                                    <h4 class="sherah-chatbox__author-title">Mahstai
                                                                    </h4>
                                                                    <p class="sherah-chatbox__author-desc">Any plan for
                                                                        today?</p>
                                                                </div>
                                                            </div>
                                                            <div class="sherah-chatbox__right">
                                                                <span
                                                                    class="sherah-chatbox__unread sherah-color1__bg">7</span>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <!-- End Single List -->
                                                ...
                                                <div class="sherah-dropdown-card__button"><a href="chat-messages.html"
                                                        class="sherah-dropdown-card__sell-all">See all Notification</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="sherah-header__dropmenu">
                                            ...
                                            <!-- sherah Alarm Hover -->
                                            <div
                                                class="sherah-dropdown-card sherah-dropdown-card__alarm sherah-border">
                                                <svg class="sherah-dropdown-arrow" xmlns="http://www.w3.org/2000/svg"
                                                    width="43.488" height="22.207" viewBox="0 0 43.488 22.207">
                                                    <path id="Path_1271" data-name="Path 1271"
                                                        d="M-15383,7197.438l20.555-20.992,20.555,20.992Z"
                                                ...
                                                <h3 class="sherah-dropdown-card__title sherah-border-btm">Recent
                                                    Notification</h3>
                                                <!-- sherah Balance List -->
                                                <ul class="sherah-dropdown-card_list">
                                                    <li>
                                                        <div class="sherah-paymentm__name">
                                                            ...
                                                            <div class="sherah-paymentm__content">
                                                                <h4 class="sherah-notifications__title">You have an
                                                                    offer! <span>successfully done</span></h4>
                                                                <p
                                                    ...
                                                    <li>
                                                        <div class="sherah-paymentm__name">
                                                            ...
                                                            <div class="sherah-paymentm__content">
                                                                <h4 class="sherah-notifications__title">You upload your
                                                                    fast product <span>successfully done</span></h4>
                                                                <p
                                                                    class="sherah-paymentm__text sherah-paymentm__text--notify">
                                                                    3 hours ago </p>
                                                            </div>
                                                    ...
                                                    <li>
                                                        <div class="sherah-paymentm__name">
                                                            ...
                                                            <div class="sherah-paymentm__content">
                                                                <h4 class="sherah-notifications__title">Your Account
                                                                    has been created <span>successfully done</span></h4>
                                                                <p
                                                                    class="sherah-paymentm__text sherah-paymentm__text--notify">
                                                                    5 hours ago</p>
                                                            </div>
                                                    ...
                                                    <li>
                                                        <div class="sherah-paymentm__name">
                                                            ...
                                                            <div class="sherah-paymentm__content">
                                                                <h4 class="sherah-notifications__title">Thank you !you
                                                                    made your fast sell <span>$120</span></h4>
                                                                <p
                                                                    class="sherah-paymentm__text sherah-paymentm__text--notify">
                                                                    6 hours ago</p>
                                                            </div>
                                        ...
                                        <div class="sherah-header__author sherah-flex__center--top">
                                            @php
                                                $authUser = auth()->user();
                                                $topAvatar = 'img/profile-pic.png';
                                                if ($authUser && !empty($authUser->avatar)) {
                                                    $candidate = public_path('storage/avatars/' . $authUser->avatar);
                                                    if (file_exists($candidate)) {
                                                        $topAvatar = asset('storage/avatars/' . $authUser->avatar) . '?v=' . filemtime($candidate);
                                                    }
                                                }
                                            @endphp
                                            <div class="sherah-header__author-img">
                                                <img src="{{ $topAvatar }}" alt="{{ optional($authUser)->name ?? 'User' }}">
                                            </div>
                                            <div class="sherah-header__author--info sherah-dflex sherah-dflex__base">
                                                <h4 class="sherah-header__author--title  sherah-dflex sherah-dflex__column">
                                                    {{ optional($authUser)->name ?? 'Account' }} <span class="sherah-header__author--text">{{ optional($authUser)->country ?? '' }}</span>
                                                </h4>
                                            ...
                                            <div
                                                ...
                                                <h3 class="sherah-dropdown-card__title sherah-border-btm">My Profile
                                                </h3>
                                                <!-- sherah Balance List -->
                                                <ul class="sherah-dropdown-card_list">
                                                    <li>
    ...
    href="{{ route('admin.profile.index') }}">My Profile</a></h4>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="sherah-dropdown-card-info">
