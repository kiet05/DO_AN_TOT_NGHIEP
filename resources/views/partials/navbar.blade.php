                ...
                <ul class="menu-bar__one sherah-dashboard-menu" id="sherahMenu">
                    ...
                    {{-- <li><a href="#!" class="collapsed" data-bs-toggle="collapse"
                            data-bs-target="#menu-item_vendors"><span class="menu-bar__text">
                                <span class="sherah-menu-icon sherah-svg-icon__v1">
                                    <svg class="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="22.038"
                                        height="17.943" viewBox="0 0 22.038 17.943">
                        ...
                        <div class="collapse sherah__dropdown" id="menu-item_vendors" data-bs-parent="#sherahMenu">
                            <ul class="menu-bar__one-dropdown">
                                <li><a href="vendor.html"><span class="menu-bar__text"><span
                    ...
                    <li>
                        <a href="#!" class="collapsed" data-bs-toggle="collapse"
                            ...
                            <span class="menu-bar__text">
                                <span class="sherah-menu-icon sherah-svg-icon__v1">
                                    <!-- SVG icon: giấy + bút (quản lý nội dung) -->
                                    <svg class="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="22"
                                        height="22" viewBox="0 0 24 24" fill="none">
                                        <path
                                            d="M4 4H14V6H6V18H18V10H20V20C20 21.1 19.1 22 18 22H6C4.9 22 4 21.1 4 20V4Z"
                                            fill="currentColor" />
                                        <path
                                            d="M20.7 2.3C21.1 1.9 21.7 1.9 22.1 2.3L22.7 2.9C23.1 3.3 23.1 3.9 22.7 4.3L14.7 12.3L12 13L12.7 10.3L20.7 2.3Z"
                                            fill="currentColor" />
                                    </svg>
                                </span>
