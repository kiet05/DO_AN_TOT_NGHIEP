        ...
        <div class="admin-menu__one sherah-sidebar-padding">
            ...
            <div class="menu-bar">
                <ul class="menu-bar__one sherah-dashboard-menu" id="sherahMenu">
                    ...
                    <li><a href="#!" class="collapsed" data-bs-toggle="collapse"
                            data-bs-target="#menu-item__return"><span class="menu-bar__text">
                                <span class="sherah-menu-icon sherah-svg-icon__v1">
                                    <svg class="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="17.092"
                                        height="17.873" viewBox="0 0 17.092 17.873">
                                        <g id="Icon" transform="translate(-409.241 -375.497)">
                                ...
                                <span class="menu-bar__name">Hoàn hàng</span></span><span
                                class="sherah__toggle"></span></a></span>
                        <!-- Dropdown Menu Order -->
                        <div class="collapse sherah__dropdown" id="menu-item__return" data-bs-parent="#sherahMenu">
                            <ul class="menu-bar__one-dropdown">
                                <li>
                                    <a href="{{ route('admin.returns.index') }}">
                                        <span class="menu-bar__text"><span class="menu-bar__name">Yêu cầu hủy đơn</span></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                        ...
                        <a href="#!" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item_payment_methods">
                            <span class="menu-bar__text">
                                <span class="sherah-menu-icon sherah-svg-icon__v1">
                                    ...
                                    <svg class="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                                        <!-- Card body with rounded corners -->
                                        <rect x="2" y="5" width="20" height="14" rx="2.5" ry="2.5" fill="none" stroke="currentColor"/>
                                        <!-- Chip -->
                                        <rect x="4" y="9" width="4" height="5" rx="0.8" fill="none" stroke="currentColor" stroke-width="1.5"/>
                                        <!-- Card number lines -->
                                        <line x1="10" y1="11" x2="18" y2="11" stroke="currentColor" stroke-width="1.5"/>
                                        <line x1="10" y1="13.5" x2="16" y2="13.5" stroke="currentColor" stroke-width="1.5"/>
                                        <!-- Expiry -->
                    ...
                    <li>
                        <a href="#!" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item_shop_settings">
                            <span class="menu-bar__text">
                                <span class="sherah-menu-icon sherah-svg-icon__v1">
                                    <!-- Premium Settings/Gear Icon -->
                                    <svg class="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                                        <!-- Outer gear -->
                                        <circle cx="12" cy="12" r="3" fill="none" stroke="currentColor"/>
                                        <!-- Gear teeth -->
                                        <path d="M12 1v3M12 20v3M4.22 4.22l2.12 2.12M17.66 17.66l2.12 2.12M1 12h3M20 12h3M4.22 19.78l2.12-2.12M17.66 6.34l2.12-2.12" stroke="currentColor" stroke-width="1.5"/>
                                        <!-- Center dot -->
