            ...
            <div class="col-lg-8">
                <div class="cart-items">
                    @foreach($cart->items as $item)
                        ...
                        <div class="cart-item {{ $isOutOfStock ? 'out-of-stock' : '' }}" data-item-id="{{ $item->id }}">
            ...
            <div class="col-lg-4">
                <div class="cart-summary">
                    ...
                    <button type="button" 
                            class="btn-checkout" 
                            id="btn-checkout"
                            onclick="alert('Chức năng thanh toán đang được phát triển. Vui lòng quay lại sau!')"
                            {{ $cart->items->filter(fn($item) => $item->isOutOfStock())->count() > 0 ? 'disabled' : '' }}>
