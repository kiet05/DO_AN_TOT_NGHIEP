                        ...
                        <div class="sherah-dsinner">
                            ...
                            <div class="row">
                                    ...
                                    <div class="sherah-page-inner sherah-border sherah-default-bg">
                                        ...
                                        <div class="sherah-page-content">
                                            ...
                                            @if (!is_null($revenueChangePercent))
                                                <div
                                                    class="small mt-1 {{ $revenueChangePercent >= 0 ? 'text-success' : 'text-danger' }}">
                                ...
                                <div class="col-md-6 col-lg-4 mg-top-10">
                                    <div class="sherah-page-inner sherah-border sherah-default-bg">
                                        ...
                                        <div class="sherah-page-content">
                                            <a
                                                href="{{ route('admin.orders.index', array_merge(request()->only(['from', 'to']), ['status' => 'completed'])) }}">
                            ...
                            <div class="row mg-top-10">
                                <div class="col-md-6 col-lg-4 mg-top-10">
                                    <div class="sherah-page-inner sherah-border sherah-default-bg">
                                        ...
                                        <div class="sherah-page-content">
                                            <a
                                                href="{{ route('admin.orders.index', array_merge(request()->only(['from', 'to']), ['status' => 'returned'])) }}">
                                                <div class="h4 mb-0">
                                ...
                                <div class="col-md-6 col-lg-4 mg-top-10">
                                    <div class="sherah-page-inner sherah-border sherah-default-bg">
                                        ...
                                        <div class="sherah-page-content">
                                            <a
                                                href="{{ route('admin.orders.index', array_merge(request()->only(['from', 'to']), ['status' => 'pending'])) }}">
                                ...
                                <div class="col-md-6 col-lg-4 mg-top-10">
                                    <div class="sherah-page-inner sherah-border sherah-default-bg">
                                        ...
                                        <div class="sherah-page-content">
                                            <a
                                                href="{{ route('admin.orders.index', array_merge(request()->only(['from', 'to']), ['status' => 'shipping'])) }}">
                                ...
                                <div class="col-md-6 col-lg-4 mg-top-10">
                                    <div class="sherah-page-inner sherah-border sherah-default-bg">
                                        ...
                                        <div class="sherah-page-content">
                                            <a
                                                href="{{ route('admin.orders.index', array_merge(request()->only(['from', 'to']), ['status' => 'shipped'])) }}">
                                                <div class="h4 mb-0">
                                ...
                                <div class="col-md-6 col-lg-4 mg-top-10">
                                    <div class="sherah-page-inner sherah-border sherah-default-bg">
                                        ...
                                        <div class="sherah-page-content">
                                            <a
                                                href="{{ route('admin.orders.index', array_merge(request()->only(['from', 'to']), ['status' => 'cancelled'])) }}">
                            ...
                            <div class="row mg-top-20">
                                <div class="col-lg-8 mg-top-10">
                                    <div class="sherah-page-inner sherah-border sherah-default-bg">
                                        <div class="sherah-page-title">
                                            <h4>Doanh thu theo tháng/năm</h4>
                                        </div>
                                        <div class="sherah-page-content">
                                            ...
                                            <tbody>
                                                @foreach ($revenueByPayment as $row)
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            {{ number_format($row->revenue, 0, ',', '.') }}đ</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <tbody>
                                            @forelse($topProducts as $i => $p)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ route('admin.orders.index', array_merge(request()->only(['from', 'to']), ['product_id' => $p->id])) }}">
                                                            {{ $p->name }}
                                                        </a>
                                                    </td>
                                                    <td class="text-end">{{ $p->qty }}</td>
                                                    <td class="text-end">{{ number_format($p->amount, 0, ',', '.') }}đ
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                                            ...
                                            <tbody>
                                                @foreach ($productReport as $i => $p)
                                                    <tr>
                                                        ...
                                                        <td class="text-end">{{ $p->qty }}</td>
                                                        <td class="text-end">
                                                            {{ number_format($p->revenue, 0, ',', '.') }}đ</td>
    ...
    <script>
        ...
        if (statusCtx) {
            new Chart(statusCtx, {
                type: 'doughnut',
                data: {
                    labels: ['Chờ xử lý', 'Đang giao', 'Đã giao', 'Đã hoàn', 'Hoàn thành', 'Đã hủy'],
                    datasets: [{
                        data: [
                            {{ $ordersByStatus['pending'] ?? 0 }},
                            {{ $ordersByStatus['shipping'] ?? 0 }},
                            {{ $ordersByStatus['shipped'] ?? 0 }},
                            {{ $ordersByStatus['returned'] ?? 0 }},
