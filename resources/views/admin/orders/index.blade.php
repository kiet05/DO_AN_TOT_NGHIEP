                                ...
                                <div class="col-12 sherah-flex-between">
                                    <div class="sherah-breadcrumb">
                                        ...
                                        <ul class="sherah-breadcrumb__list">
                                            ...
                                            <li class="active"><a href="{{ route('admin.orders.index') }}">Đơn hàng</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table align-middle">
                                        ...
                                        <tbody>
                                            @forelse($orders as $order)
                                                @php
                                                    // Chuẩn hoá status: xử lý cả dữ liệu cũ
                                                    $rawStatus = $order->order_status;
                                                    $aliases   = [
                                                        'success'  => 'completed',
                                                        'canceled' => 'cancelled',
                                                    ];
                                                    $statusKey   = $aliases[$rawStatus] ?? $rawStatus;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="{{ $paymentClass }}">{{ $order->payment_status_label }}</td>
                                                    <td>
