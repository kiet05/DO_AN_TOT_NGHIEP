        ...
        <div class="sherah-body">
          <div class="sherah-dsinner">
            ...
            <div class="row mg-top-30">
              <div class="col-12 sherah-flex-between">
                <div class="sherah-breadcrumb">
                  <h2 class="sherah-breadcrumb__title">Sửa khách hàng</h2>
                  <ul class="sherah-breadcrumb__list">
                    <li><a href="{{ route('admin.dashboard') }}">Home</a></li>
                    <li><a href="{{ route('admin.customers.index') }}">Khách hàng</a></li>
                    <li class="active"><a href="#">Sửa</a></li>
                  </ul>
                </div>
            ...
            <div class="sherah-page-inner sherah-border sherah-default-bg mg-top-25 p-20">
              ...
              <form method="POST" action="{{ route('admin.customers.update',$customer->id) }}" class="row g-3">
                @csrf @method('PUT')
                ...
                <div class="col-md-6">
                  ...
                  <select name="status" class="form-select" required>
                    ...
                    <option value="0" {{ old('status',$customer->status)==0?'selected':'' }}>Bị khóa</option>
                  </select>
                </div>

                <div class="col-12">
                  <button type="submit" class="sherah-btn sherah-gbcolor">Cập nhật</button>
                </div>
              </form>
            </div>
