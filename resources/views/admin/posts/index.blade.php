                                            ...
                                            <tbody>
                                                @forelse ($posts as $post)
                                                    <tr>
                                                        ...
                                                        <td class="text-muted cell-content"
                                                            title="{{ strip_tags($post->content) }}">
                                                            {{ Str::limit(strip_tags($post->content), 160) }}
                                                        </td>
                                                        <td>
                                                            @if (request('status') === 'trash')
                                                                <span class="badge bg-warning text-dark">Trong thùng
                                                                    rác</span>
                                                            @else
                                                                ...
                                                                @else
                                                                    <span
                                                                        class="badge bg-secondary d-inline-flex align-items-center px-3 py-2">
                                                                        ...
                                                                        <li>
                                                                            <form method="POST"
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    <i class="bi bi-x-octagon"></i>Xóa vĩnh
                                                                                    viễn
                                                                                </button>
                                                                            </form>
                                                                        </li>
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="6" class="text-center text-muted py-4">Chưa có bài
                                                            viết nào.</td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
