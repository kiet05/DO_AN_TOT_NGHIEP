...
@section('content')
    ...
    <div class="container-fluid">
        <div class="bn-card">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                <div>
                    <h3 class="mb-1"><i class="bi bi-image me-2"></i>Thêm banner mới</h3>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="position" class="form-select @error('position') is-invalid @enderror">
                                    ...
                                    <option value="bottom" {{ old('position', 'bottom') === 'bottom' ? 'selected' : '' }}>Bottom
                                    </option>
                                </select>
                                @error('position')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="status">Bật (hiển thị ngay)</label>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    {{-- JS: preview ảnh + kiểm tra size đơn giản --}}
    <script>
        (function() {
